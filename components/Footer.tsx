...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#f5eddd] border-t border-[#C9A84C]/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-6">Finance Operations, Elevated.</p>
            ...
            <form onSubmit={handleSubmit} className="mb-6">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2.5 bg-white border border-border rounded-lg text-foreground placeholder-[#6B7280] focus:outline-none focus:ring-2 focus:ring-[#C9A84C]/50 focus:border-[#C9A84C] transition-all"
                />
                <button
                  type="submit"
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 rounded-full bg-white border border-border flex items-center justify-center text-muted-foreground hover:text-[#C9A84C] hover:border-[#C9A84C] transition-colors shadow-sm"
                aria-label="LinkedIn"
              >
              ...
              {footerLinks.services.map((link) => (
                <li key={link.label}>
                  <Link
                    ...
                    className="text-muted-foreground hover:text-[#C9A84C] transition-colors relative group"
                  >
                    {link.label}
